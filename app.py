...
if uploaded_file:
    ...
    try:
        ...
        results['Zivot-Andrews'] = {
            ...
            'p-value': za.pvalue,
            'Breakpoint': ts.index[za.break_idx].strftime('%Y-%m-%d')  # Fixed attribute name
        }
        ...
        ax2.axvline(ts.index[za.break_idx], color='red', linestyle='--', label='Zivot-Andrews Break')  # Fixed attribute name
        ...
        heatmap_buffer.seek(0)  # Reset buffer position
